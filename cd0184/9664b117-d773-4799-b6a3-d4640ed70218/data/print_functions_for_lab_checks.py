...
def check_calculating_results(results_dic, results_stats_dic):
    ...
    if results_stats_dic is None:
        ...
        pct_corr_dog = (n_class_cdog / n_pet_dog) * \
            100 if n_pet_dog > 0 else 0.0
        pct_corr_notdog = (n_class_cnotd / n_pet_notd) * \
            100 if n_pet_notd > 0 else 0.0
        pct_corr_breed = (n_match_breed / n_pet_dog) * \
            100 if n_pet_dog > 0 else 0.0
